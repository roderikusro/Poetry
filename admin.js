  ...
  div.innerHTML = `
    <div class="stanza-field-header">
      ...
      <div style="display:flex; align-items:center; gap: 8px;">
        ...
        <input type="text" class="admin-input stanza-time-input" placeholder="00:00" value="${formatTimeToMinutes(timestamp)}" style="width: 80px; padding: 4px 8px; min-height: unset; height: 32px; text-align: center;" title="Menit:Detik (misal: 01:15)">
